...
INSERT INTO "new_Coaster" ("closed", "id", "latitude", "longitude", "name", "opened", "parkId", "ridden", "riddenDate") SELECT "closed", "id", "latitude", "longitude", "name", "opened", "parkId", "ridden", "riddenDate" FROM "Coaster";
DROP TABLE "Coaster";
